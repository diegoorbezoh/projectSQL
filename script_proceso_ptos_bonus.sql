...
--FROM    STAGE.[dbo].[TRX_TICKET_BONUS]

--SELECT  DISTINCT SK_DIA
--FROM    "g200603svhb5\ic_dw".DW_CENCOFCIC.DBO.FACT_TICKET_BONUS


--DELETE FROM STAGE.[dbo].[TRX_TICKET_BONUS] WHERE COD_DIA = 20200401
--DELETE FROM "g200603svhb5\ic_dw".DW_CENCOFCIC.DBO.FACT_TICKET_BONUS WHERE SK_DIA = 20200401


---

--SELECT  SUM(MTO_VENTA_NETA_BONUS_IDEN)IDEN,SUM(MTO_VENTA_NETA_BONUS)TOTAL
--FROM    STAGE.[dbo].[TRX_TICKET_BONUS] WITH(NOLOCK)
--WHERE   ID_TIPO_BONUS = 1 AND COD_DIA = 20200401 AND COD_CADENA = '01'

--SELECT  SUM(MTO_VENTA_NETA_BONUS_IDEN)IDEN,SUM(MTO_VENTA_NETA_BONUS)TOTAL
--FROM    "g200603svhb5\ic_dw".DW_CENCOFCIC.DBO.FACT_TICKET_BONUS A
--INNER JOIN  [g200603svhb5\ic_dw].[DW_CENCOFCIC].[dbo].[DIM_TIENDA] B ON A.SK_TIENDA = B.SK_TIENDA
--WHERE   A.ID_TIPO_BONUS = 1 AND A.SK_DIA = 20200401 AND B.SK_CADENA = 1